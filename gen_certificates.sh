...
# Put some nice descriptions in the certs dir
echo "This directory contains files generated by the gen_certificates.sh script" > certs/README
echo " " >> certs/README
echo "ca_root.key is the private part of the root certificate." >> certs/README
echo "ca_root.crt is the public part of the root certificate." >> certs/README
echo "ca_sub.key is the private part of the sub-certificate." >> certs/README
echo "ca_sub.crt is the public part of the sub-certificate. It has been signed by the root certificate." >> certs/README
echo "nodeconf.key is the private part of the node-configurator certificate." >> certs/README
echo "nodeconf.crt is the public part of the node-configurator certificate. It has been signed by the subordinate CA certificate." >> certs/README
echo "nodeconf_chain.crt contains both the contents of ca_sub.crt and nodeconf.crt" >> certs/README


# Restore global read access
chmod 755 certs
...
echo "  ca_sub.crt and nodeconf.crt combined: certs/nodeconf_chain.crt"
