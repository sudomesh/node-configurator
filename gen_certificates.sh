...
echo "This directory contains files generated by the gen_certificates.sh script\n" > certs/README
echo "\n" >> certs/README
echo "ca_root.key is the private part of the root certificate.\n" >> certs/README
echo "ca_root.crt is the public part of the root certificate.\n" >> certs/README
echo "ca_sub.key is the private part of the sub-certificate..\n" >> certs/README
echo "ca_sub.crt is the public part of the sub-certificate. It has been signed by the root certificate.\n" >> certs/README
echo "nodeconf.key is the private part of the node-configurator certificate.\n" >> certs/README
echo "nodeconf.crt is the public part of the node-configurator certificate. It has been signed by the subordinate CA certificate.\n" >> certs/README
